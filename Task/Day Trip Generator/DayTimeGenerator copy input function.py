...
# user_destination = input(print("What is your destination?", destination_list))
# user_restaurant = input(print("What is your restaurant?", restaurant_list))
# user_mode_of_transportation = input(print("What is your mode of transportation?", mode_of_transportation_list))
# user_entertainment = input(print("What is your entertainment?", entertainment_list))
...
while will_not_do == True:
    if input(print("What is your destination?", destination_list)) == ideal_destination:
        will_not_do = False
...
while will_not_do == True:
    if input(print("What is your restaurant?", restaurant_list)) == ideal_restaurant:
        will_not_do = False
...
while will_not_do == True:
    if input(print("What is your mode of transportation?", mode_of_transportation_list)) == ideal_mode_of_transportation:
        will_not_do = False
...
while will_not_do == True:
    if input(print("What is your entertainment?", entertainment_list)) == ideal_entertainment:
        will_not_do = False
